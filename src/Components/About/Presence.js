...
/>
        ...
        <div className="w-full md:w-1/2 lg:w-3/5 md:pl-8">
          ...
          <p className="mb-4">
            ZanithPay Info Solutions Private Limited offers its users the facility of Online Recharge, Money Transfer, Bus Booking, Flight Booking, Cab Booking, and Hotel Booking.
          </p>
          <p>
            ZanithPay Info Solutions Private Limited provides Business to Business services through its portal. Join us to earn additional benefits. We offer attractive margins for all prepaid/postpaid operators, including Airtel, Vodafone, Videocon, Aircel, Tata Docomo, Idea, BSNL, Reliance, MTS, and leading DTH operators such as Dish TV, TATA Sky, Sun Direct, Videocon D2h, Reliance Digital TV, Airtel Digital TV, and all other booking services.
          </p>
        </div>
      </div>
    </div>
